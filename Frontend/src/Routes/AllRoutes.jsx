...
import ProductCtard from '../Components/Product-Page-Component/ProductCard'
const AllRoutes = () => {
  return (
    <Routes>
      <Route path='/' element={<Homepage />}></Route>
      <Route path='/product' element={<ProductCtard />}></Route>
      ...
      <Route path='/car' element={<AddCart />}></Route>
